...
## 13.1 Overview <a href="#s-13-1" id="s-13-1"></a>
...
## 13.2 MATCH Replays <a href="#s-13-2" id="s-13-2"></a>

{% hint style="success" %}
#### T201 \*Replay는 허용되지만 드뭅니다. <a href="#rule-t201" id="rule-t201"></a>
...
{% hint style="success" %}
#### T202 \*Replay에서는 Original MATCH의 조건을 재현합니다. <a href="#rule-t202" id="rule-t202"></a>
...
## 13.3 Clarifications on MATCH Play Results (“Question Box”) <a href="#s-13-3" id="s-13-3"></a>
...
{% hint style="success" %}
#### T301 \*Head REFEREE와의 Interaction. <a href="#rule-t301" id="rule-t301"></a>
...
{% hint style="success" %}
#### T302 \*MATCH 질문은 제때 해야 합니다. <a href="#rule-t302" id="rule-t302"></a>
...
{% hint style="success" %}
#### T303 \*질문은 사실에 기반하고 건설적으로 하십시오. <a href="#rule-t303" id="rule-t303"></a>
...
## 13.4 General Tournament Rules <a href="#s-13-4" id="s-13-4"></a>

{% hint style="success" %}
#### T401 \*Event 중 Gameplay에 관한 최종 권한은 Head REFEREE에게 있습니다. <a href="#rule-t401" id="rule-t401"></a>
...
{% hint style="success" %}
#### T402 \*REFEREE만 ROBOT을 DISABLED로 선언할 수 있습니다. <a href="#rule-t402" id="rule-t402"></a>
...
{% hint style="success" %}
#### T403 \*Event의 Non-gameplay Decision에 관한 최종 권한은 Event Director에게 있습니다. <a href="#rule-t403" id="rule-t403"></a>
...
{% hint style="success" %}
#### T404 \*Event의 모든 Competition FIELD는 서로 일관되어야 합니다. <a href="#rule-t404" id="rule-t404"></a>
...
{% hint style="success" %}
#### T405 \*선택적 FIELD Measurement/Calibration 시간에는 ROBOT Practice를 할 수 없습니다. <a href="#rule-t405" id="rule-t405"></a>
...
{% hint style="success" %}
#### T406 \*Team Timeout은 없지만 MATCH 사이 Break는 있습니다. <a href="#rule-t406" id="rule-t406"></a>
...
{% hint style="success" %}
#### T407 \*MATCH는 순서대로 진행합니다. <a href="#rule-t407" id="rule-t407"></a>
...
## 13.5 Practice MATCHES <a href="#s-13-5" id="s-13-5"></a>
...
### 13.5.1 Filler Line <a href="#s-13-5-1" id="s-13-5-1"></a>
...
## 13.6 Qualification MATCHES <a href="#s-13-6" id="s-13-6"></a>

### 13.6.1 Schedule <a href="#s-13-6-1" id="s-13-6-1"></a>
...
![Figure 13-1 · Sample MATCH Schedule](.gitbook/assets/image-064.png)

**Figure 13-1 · Sample MATCH Schedule**

### 13.6.2 MATCH Assignment <a href="#s-13-6-2" id="s-13-6-2"></a>
...
### 13.6.3 Qualification Ranking <a href="#s-13-6-3" id="s-13-6-3"></a>
...
| ----- | ------------------------------------------------------------------------ |
| 1위    | RANKING SCORE (RS)                                                       |
| 2위    | 평균 ALLIANCE MATCH 포인트 — MINOR FOUL 및 MAJOR FOUL 제외 (평균 MATCH 포인트 − FOUL) |
| 3위    | 평균 TIP 횟수                                                                |
| 4위    | 평균 AUTO 포인트                                                              |
| 5위    | FIRST Event Management Software에 의한 무작위 정렬                               |

{% hint style="success" %}
#### T601 \*Qualification에서 DISQUALIFICATION은 DISQUALIFIED된 팀에만 적용됩니다. <a href="#rule-t601" id="rule-t601"></a>

Qualification MATCH에서 한 팀의 DISQUALIFICATION은 ALLIANCE Partner에게 영향을 주지 않습니다.
{% endhint %}

## 13.7 Playoff MATCHES <a href="#s-13-7" id="s-13-7"></a>
...
{% hint style="success" %}
#### T701 \*STUDENT Representative 1명 또는 2명을 보내십시오. <a href="#rule-t701" id="rule-t701"></a>
...
{% hint style="success" %}
#### T702 \*초대를 Decline한 팀은 다시 Pick될 수 없습니다. <a href="#rule-t702" id="rule-t702"></a>
...
{% hint style="success" %}
#### T703 \*Playoff MATCH에는 Backup Team이 없습니다. <a href="#rule-t703" id="rule-t703"></a>
...
{% hint style="success" %}
#### T704 \*Playoff MATCH 중 Team은 추가 ARENA Access를 받을 수 있습니다. <a href="#rule-t704" id="rule-t704"></a>
...
{% hint style="success" %}
#### T705 \*여러 DISQUALIFICATION은 특별히 처리합니다. <a href="#rule-t705" id="rule-t705"></a>
...
### 13.7.1 ALLIANCE Selection Process <a href="#s-13-7-1" id="s-13-7-1"></a>
...
### 13.7.2 Playoff MATCH Bracket <a href="#s-13-7-2" id="s-13-7-2"></a>
...
| Playoff 참가 자격이 있는 전체 Team 수 | 구성되는 Playoff ALLIANCE 수 |
| --------------------------- | ----------------------- |
| 4–10 Teams                  | 2                       |
| 11–20 Teams                 | 4                       |
| 21–40 Teams                 | 6                       |
...
![Figure 13-2 · 8-ALLIANCE playoff bracket](.gitbook/assets/image-065.png)
...
### 13.7.3 2-ALLIANCE Bracket and Typical Timing <a href="#s-13-7-3" id="s-13-7-3"></a>

![Figure 13-3 · 2-ALLIANCE playoff bracket](.gitbook/assets/image-066.png)

**Figure 13-3 · 2-ALLIANCE playoff bracket**

**Table 13-3 · 2-ALLIANCE playoff bracket typical timing**

<table><thead><tr><th>Round</th><th>MATCH</th><th>Upper/Lower</th><th></th><th></th><th></th><th>Gap (min)</th><th></th><th>Next MATCH (MATCH # (ALLIANCE color))</th><th></th><th>Estimated Start (min)</th></tr></thead><tbody><tr><td></td><td></td><td></td><td>FIELD</td><td>Blue</td><td>Red</td><td>Blue</td><td>Red</td><td>Winner</td><td>Loser</td><td></td></tr><tr><td colspan="10">15-minute break<br>Judges’ Choice* (1), Innovate/Design/Control Award (1)</td><td>0</td></tr><tr><td>Finals</td><td>1</td><td></td><td>1</td><td>A2</td><td>A1</td><td></td><td></td><td>M2</td><td>M2</td><td>15</td></tr><tr><td colspan="10">15-minute break<br>Sustain/Reach/Connect Award (1)</td><td>18</td></tr><tr><td>Finals</td><td>2</td><td></td><td>1</td><td>A2</td><td>A1</td><td>0:15</td><td>0:15</td><td>M3*</td><td>M3*</td><td>33</td></tr><tr><td colspan="10">15-minute break<br>Think Award (1)</td><td>36</td></tr><tr><td>Finals</td><td>3*</td><td></td><td>1</td><td>A2</td><td>A1</td><td>0:10</td><td>0:10</td><td></td><td></td><td>51</td></tr><tr><td colspan="10">Awards: Compass*, Finalists, Winners, and Inspire Award (1)</td><td>54</td></tr></tbody></table>

\* 필요한 경우

\*\* Award는 Event Director의 재량으로 Playoff Bracket 종료 후 수여할 수 있습니다.

### 13.7.4 4-ALLIANCE Bracket and Typical Timing <a href="#s-13-7-4" id="s-13-7-4"></a>

![Figure 13-4 · 4-ALLIANCE playoff bracket](.gitbook/assets/image-067.png)

**Figure 13-4 · 4-ALLIANCE playoff bracket**

**Table 13-4 · 4-ALLIANCE playoff typical timing**

<table><thead><tr><th>Round</th><th>MATCH</th><th>Upper/Lower</th><th></th><th></th><th></th><th>Gap (min)</th><th></th><th>Next MATCH (MATCH # (ALLIANCE color))</th><th></th><th>Estimated Start (min)</th></tr></thead><tbody><tr><td></td><td></td><td></td><td>FIELD</td><td>Blue</td><td>Red</td><td>Blue</td><td>Red</td><td>Winner</td><td>Loser</td><td></td></tr><tr><td rowspan="2">1</td><td>1</td><td>Upper</td><td>1</td><td>A4</td><td>A1</td><td></td><td></td><td>M4 (R)</td><td>M3 (R)</td><td>0</td></tr><tr><td>2</td><td>Upper</td><td>1</td><td>A3</td><td>A2</td><td></td><td></td><td>M4 (B)</td><td>M3 (B)</td><td>6</td></tr><tr><td colspan="10">15-minute break</td><td>9</td></tr><tr><td rowspan="2">2</td><td>3</td><td>Lower</td><td>1</td><td>L2</td><td>L1</td><td>0:08</td><td>0:14</td><td>M5 (B)</td><td>4th</td><td>25</td></tr><tr><td>4</td><td>Upper</td><td>1</td><td>W2</td><td>W1</td><td>0:14</td><td>0:20</td><td>M6 (R)</td><td>M5 (R)</td><td>31</td></tr><tr><td colspan="10">15-minute break<br>Judges’ Choice* (1), Design Award (1), Reach Award (1)</td><td>33</td></tr><tr><td>3</td><td>5</td><td>Lower</td><td>1</td><td>W3</td><td>L4</td><td>0:21</td><td>0:15</td><td>M6 (B)</td><td>3rd</td><td>48</td></tr><tr><td colspan="10">15-minute break<br>Control Award (1), Innovate Award (1), Sustain Award (1)</td><td>51</td></tr><tr><td>Finals</td><td>6</td><td></td><td>1</td><td>W5</td><td>W4</td><td>0:15</td><td>0:33</td><td>M7*</td><td>M7*</td><td>66</td></tr><tr><td colspan="10">15-minute break<br>Connect Award (1), Think Award (1)</td><td>69</td></tr><tr><td>Finals</td><td>7*</td><td></td><td>1</td><td>W5</td><td>W4</td><td>0:15</td><td>0:15</td><td></td><td></td><td>84</td></tr><tr><td colspan="10">Awards: Compass*, Finalists, Winners, and Inspire Award (2, 1)</td><td>87</td></tr></tbody></table>

\* 필요한 경우

\*\* Award는 Event Director의 재량으로 Playoff Bracket 종료 후 수여할 수 있습니다.

### 13.7.5 6-ALLIANCE Bracket and Typical Timing <a href="#s-13-7-5" id="s-13-7-5"></a>

![Figure 13-5 · 6-ALLIANCE playoff bracket](.gitbook/assets/image-068.png)

**Figure 13-5 · 6-ALLIANCE playoff bracket**

**Table 13-5 · 6-ALLIANCE playoff bracket typical timing**

<table><thead><tr><th>Round</th><th>MATCH</th><th>Upper/Lower</th><th></th><th></th><th></th><th>Gap (min)</th><th></th><th>Next MATCH (MATCH # (ALLIANCE color))</th><th></th><th>Estimated Start (min)</th></tr></thead><tbody><tr><td></td><td></td><td></td><td>FIELD</td><td>Blue</td><td>Red</td><td>Blue</td><td>Red</td><td>Winner</td><td>Loser</td><td></td></tr><tr><td rowspan="2">1</td><td>1</td><td>Upper</td><td>1</td><td>A5</td><td>A4</td><td></td><td></td><td>M3 (B)</td><td>M6 (B)</td><td>0</td></tr><tr><td>2</td><td>Upper</td><td>2</td><td>A6</td><td>A3</td><td></td><td></td><td>M4 (B)</td><td>M5 (B)</td><td>6</td></tr><tr><td rowspan="2">2</td><td>3</td><td>Upper</td><td>1</td><td>W1</td><td>A1</td><td>0:09</td><td></td><td>M7 (R)</td><td>M5 (R)</td><td>12</td></tr><tr><td>4</td><td>Upper</td><td>2</td><td>W2</td><td>A2</td><td>0:09</td><td></td><td>M7 (B)</td><td>M6 (R)</td><td>18</td></tr><tr><td rowspan="2">3</td><td>5</td><td>Lower</td><td>1</td><td>L2</td><td>L3</td><td>0:15</td><td>0:09</td><td>M8 (B)</td><td>Tied 5th</td><td>24</td></tr><tr><td>6</td><td>Lower</td><td>2</td><td>L1</td><td>L4</td><td>0:27</td><td>0:09</td><td>M8 (R)</td><td></td><td>30</td></tr><tr><td rowspan="2">4</td><td>7</td><td>Upper</td><td>1</td><td>W4</td><td>W3</td><td>0:15</td><td>0:21</td><td>M10 (R)</td><td>M9 (R)</td><td>36</td></tr><tr><td>8</td><td>Lower</td><td>2</td><td>W5</td><td>W6</td><td>0:15</td><td>0:09</td><td>M9 (B)</td><td>4th</td><td>42</td></tr><tr><td colspan="10">15-minute break<br>Judges’ Choice* (1), Design Award (2, 1), Reach Award (2, 1)</td><td>45</td></tr><tr><td>5</td><td>9</td><td>Lower</td><td>1</td><td>W8</td><td>L7</td><td>0:15</td><td>0:21</td><td>M10 (B)</td><td>3rd</td><td>60</td></tr><tr><td colspan="10">15-minute break<br>Control Award (2, 1), Innovate Award (2, 1), Sustain Award (2,1)</td><td>63</td></tr><tr><td>Finals</td><td>10</td><td></td><td>1</td><td>W9</td><td>W7</td><td>0:15</td><td>0:39</td><td>M11*</td><td>M11*</td><td>78</td></tr><tr><td colspan="10">15-minute break<br>Connect Award (2, 1), Think Award (2, 1)</td><td>81</td></tr><tr><td>Finals*</td><td>11</td><td></td><td>1</td><td>W9</td><td>W7</td><td>0:15</td><td>0:15</td><td></td><td></td><td>96</td></tr><tr><td colspan="10">Awards: Compass*, Finalists, Winners, and Inspire Award (3, 2, 1)</td><td>99</td></tr></tbody></table>

\* 필요한 경우

\*\* Award는 Event Director의 재량으로 Playoff Bracket 종료 후 수여할 수 있습니다.

### 13.7.6 8-ALLIANCE Bracket and Typical Timing <a href="#s-13-7-6" id="s-13-7-6"></a>

![Figure 13-6 · 8-ALLIANCE playoff bracket](.gitbook/assets/image-069.png)

**Figure 13-6 · 8-ALLIANCE playoff bracket**

**Table 13-6 · 8-ALLIANCE playoff bracket typical timing**

<table><thead><tr><th>Round</th><th>MATCH</th><th>Upper/Lower</th><th></th><th></th><th></th><th>Gap (min)</th><th></th><th>Next MATCH (MATCH # (ALLIANCE color))</th><th></th><th>Estimated Start (min)</th></tr></thead><tbody><tr><td></td><td></td><td></td><td>FIELD</td><td>Blue</td><td>Red</td><td>Blue</td><td>Red</td><td>Winner</td><td>Loser</td><td></td></tr><tr><td rowspan="4">1</td><td>1</td><td>Upper</td><td>1</td><td>A8</td><td>A1</td><td></td><td></td><td>M7 (R)</td><td>M5 (R)</td><td>0</td></tr><tr><td>2</td><td>Upper</td><td>2</td><td>A5</td><td>A4</td><td></td><td></td><td>M7 (B)</td><td>M5 (B)</td><td>6</td></tr><tr><td>3</td><td>Upper</td><td>1</td><td>A7</td><td>A2</td><td></td><td></td><td>M8 (R)</td><td>M6 (R)</td><td>12</td></tr><tr><td>4</td><td>Upper</td><td>2</td><td>A6</td><td>A3</td><td></td><td></td><td>M8 (B)</td><td>M6 (B)</td><td>18</td></tr><tr><td rowspan="4">2</td><td>5</td><td>Lower</td><td>1</td><td>L2</td><td>L1</td><td>0:15</td><td>0:21</td><td>M10 (B)</td><td>Tied 7th</td><td>24</td></tr><tr><td>6</td><td>Lower</td><td>2</td><td>L4</td><td>L3</td><td>0:09</td><td>0:15</td><td>M9 (B)</td><td></td><td>30</td></tr><tr><td>7</td><td>Upper</td><td>1</td><td>W2</td><td>W1</td><td>0:27</td><td>0:33</td><td>M11 (R)</td><td>M9 (R)</td><td>36</td></tr><tr><td>8</td><td>Upper</td><td>2</td><td>W4</td><td>W3</td><td>0:21</td><td>0:27</td><td>M11 (B)</td><td>M10 (R)</td><td>42</td></tr><tr><td rowspan="2">3</td><td>9</td><td>Lower</td><td>1</td><td>W6</td><td>L7</td><td>0:15</td><td>0:09</td><td>M12 (B)</td><td>Tied 5th</td><td>48</td></tr><tr><td>10</td><td>Lower</td><td>2</td><td>W5</td><td>L8</td><td>0:27</td><td>0:09</td><td>M12 (R)</td><td></td><td>54</td></tr><tr><td rowspan="2">4</td><td>11</td><td>Upper</td><td>1</td><td>W8</td><td>W7</td><td>0:15</td><td>0:21</td><td>M14 (R)</td><td>M13 (R)</td><td>60</td></tr><tr><td>12</td><td>Lower</td><td>2</td><td>W9</td><td>W10</td><td>0:15</td><td>0:09</td><td>M13 (B)</td><td>4th</td><td>66</td></tr><tr><td colspan="10">15-minute break<br>Judges’ Choice* (1), Design Award (3,2,1), Reach Award (3,2,1)</td><td>69</td></tr><tr><td>5</td><td>13</td><td>Lower</td><td>1</td><td>W12</td><td>L11</td><td>0:15</td><td>0:21</td><td>M14 (B)</td><td>3rd</td><td>84</td></tr><tr><td colspan="10">15-minute break<br>Control Award (3,2,1), Innovate Award (3,2,1), Sustain Award (3,2,1)</td><td>87</td></tr><tr><td>Finals</td><td>14</td><td></td><td>1</td><td>W13</td><td>W11</td><td>0:15</td><td>0:39</td><td>M15*</td><td>M15*</td><td>102</td></tr><tr><td colspan="10">15-minute break<br>Connect Award (3,2,1), Think Award (3,2,1)</td><td>105</td></tr><tr><td>Finals*</td><td>15</td><td></td><td>1</td><td>W13</td><td>W11</td><td>0:15</td><td>0:15</td><td></td><td></td><td>120</td></tr><tr><td colspan="10">Awards: Compass*, Finalists, Winners, and Inspire Award (3, 2, 1)</td><td>123</td></tr></tbody></table>

\* 필요한 경우

\*\* Award는 Event Director의 재량으로 Playoff Bracket 종료 후 수여할 수 있습니다.

## 13.8 Dual Division Events <a href="#s-13-8" id="s-13-8"></a>
...
{% hint style="success" %}
#### T801 \*두 Division은 같은 크기의 Playoff Bracket을 사용합니다. <a href="#rule-t801" id="rule-t801"></a>

Playoff ALLIANCE 수는 Table 13-2에 따라 **더 작은 Division의 Playoff 참가 자격 Team 수**를 기준으로 결정합니다.
{% endhint %}

{% hint style="success" %}
#### T802 \*Dual Division Award는 Event Level에서 수여합니다. <a href="#rule-t802" id="rule-t802"></a>

모든 Award는 Division Level이 아니라 전체 Tournament Level에서 Judging되고 수여됩니다.
{% endhint %}

{% hint style="success" %}
#### T803 \*Dual Division Award 수는 전체 Team 수를 기준으로 합니다. <a href="#rule-t803" id="rule-t803"></a>

Dual Division Event에서 수여되는 Award 수는 Table 6-1을 사용해 전체 참가 Team 수를 기준으로 결정합니다.
{% endhint %}

### 13.8.1 Dual Division Advancement Points <a href="#s-13-8-1" id="s-13-8-1"></a>
...
| ------------------- | --------------------------------------------------------------------------------------------- |
| Playoff Advancement | <p>1위(Winners) 40점<br>2위(Finalists) 20점<br>모든 Division Finalists 10점<br>모든 Division 3위 5점</p> |

### 13.8.2 Dual Division Playoffs <a href="#s-13-8-2" id="s-13-8-2"></a>
...
![Figure 13-7 · 2-ALLIANCE grand finals playoff bracket (Dual Division)](.gitbook/assets/image-070.png)
