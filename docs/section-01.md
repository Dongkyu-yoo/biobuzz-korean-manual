...
## 1.2 FIRST® Tech Challenge {#s-1-2}
...
## 1.3 FIRST Ethos와 Core Values {#s-1-3}

### 1.3.1 Gracious Professionalism® {#s-1-3-1}
...
![Dr. Woodie Flowers speaking at FIRST Championship](assets/image-003.jpg)

> “FIRST 정신은 모든 사람이 가치 있게 대우받는 방식으로 높은 수준의, 충분한 지식에 근거한 일을 하도록 장려합니다. Gracious Professionalism은 FIRST 정신의 일부를 설명하기에 좋은 표현인 것 같습니다. 이것은 FIRST를 특별하고 훌륭하게 만드는 요소 중 하나입니다.”<br>
> **— Dr. Woodie Flowers**
...
![Gracious Professionalism word cloud](assets/image-004.png)

### 1.3.2 Coopertition® {#s-1-3-2}
...
### 1.3.4 왜 FIRST Ethos와 Gracious Professionalism을 받아들여야 하는가? {#s-1-3-4}
...
### 1.4.1 FIRST Staff의 메시지 {#s-1-4-1}
...
### 1.4.2 Framework of Behaviors {#s-1-4-2}
...
- **Gracious Professionalism &amp; FIRST Core Values**<br>
...
- **Competition Rules: Competition Manual, Team Updates, Q&amp;A**<br>
...
> **멘토나 코치와 함께 일하는 것은 학습 과정의 중요한 부분입니다.**<br>
...
## 1.5 Competition Integrity Contract (CIC) {#s-1-5}
...
### 1.5.1 Sporting Ethics Code {#s-1-5-1}
...
### 1.5.2 Behavior Guidelines {#s-1-5-2}
...
*우리는 팀원을 지지합니다. 파트너를 칭찬합니다. 상대를 축하합니다.*
...
### 1.5.3 위반, 완화 조치 및 상향 보고 {#s-1-5-3}
...
## 1.7 Competition Manual 이해 및 활용 {#s-1-7}

### 1.7.1 이 문서와 표기 규칙 {#s-1-7-1}
...
![FIRST official Rule numbering example diagram](assets/image-005.png)
...
### 1.7.4 Question &amp; Answer System {#s-1-7-4}
