...
## 11.1 Personal Safety <a href="#s-11-1" id="s-11-1"></a>

{% hint style="success" %}
#### G101 \*Humans, MATCH 중 FIELD에 들어가지 마십시오. <a href="#rule-g101" id="rule-g101"></a>
...
{% hint style="success" %}
#### G102 \*ARENA Element와 상호작용할 때 주의하십시오. <a href="#rule-g102" id="rule-g102"></a>
...
## 11.2 Conduct <a href="#s-11-2" id="s-11-2"></a>

{% hint style="success" %}
#### G201 \*좋은 사람이 되십시오. <a href="#rule-g201" id="rule-g201"></a>
...
{% hint style="success" %}
#### G202 \*Competition Integrity Contract(CIC)를 따르십시오. <a href="#rule-g202" id="rule-g202"></a>
...
{% hint style="success" %}
#### G203 \*자신의 MATCH에 참석하십시오. <a href="#rule-g203" id="rule-g203"></a>
...
{% hint style="success" %}
#### G204 \*다른 팀을 해쳐 이득을 얻으려 하지 마십시오. <a href="#rule-g204" id="rule-g204"></a>
...
{% hint style="success" %}
#### G205 \*심각하거나 예외적인 위반. <a href="#rule-g205" id="rule-g205"></a>
...
## 11.3 Pre-MATCH <a href="#s-11-3" id="s-11-3"></a>

{% hint style="success" %}
#### G301 \*MATCH를 지연시키지 마십시오. <a href="#rule-g301" id="rule-g301"></a>
...
{% hint style="success" %}
#### G302 \*FIELD에 가져오는 물품을 제한하십시오. <a href="#rule-g302" id="rule-g302"></a>
...
{% hint style="success" %}
#### G303 \*FIELD의 ROBOT은 MATCH를 플레이할 준비가 되어 있어야 합니다. <a href="#rule-g303" id="rule-g303"></a>
...
{% hint style="success" %}
#### G304 \*ROBOT을 FIELD에 올바르게 배치하십시오. <a href="#rule-g304" id="rule-g304"></a>
...
>
> <img src=".gitbook/assets/image-051.png" alt="Figure 11-1 · 허용되는 ROBOT Starting Location 예" data-size="original">
>
> **Figure 11-1 · 허용되는 ROBOT Starting Location 예**
{% endhint %}

{% hint style="success" %}
#### G305 \*OpMode를 선택하십시오. <a href="#rule-g305" id="rule-g305"></a>
...
## 11.4 In-MATCH <a href="#s-11-4" id="s-11-4"></a>

### 11.4.1 AUTO <a href="#s-11-4-1" id="s-11-4-1"></a>

{% hint style="success" %}
#### G401 \*AUTO 중 ROBOT과 상호작용하지 마십시오. <a href="#rule-g401" id="rule-g401"></a>
...
{% hint style="success" %}
#### G402 AUTO에서 상대를 방해하지 마십시오. <a href="#rule-g402" id="rule-g402"></a>
...
### 11.4.2 TELEOP <a href="#s-11-4-2" id="s-11-4-2"></a>

{% hint style="success" %}
#### G403 \*AUTO와 TELEOP 사이 ROBOT은 정지해야 합니다. <a href="#rule-g403" id="rule-g403"></a>
...
{% hint style="success" %}
#### G404 \*TELEOP 종료 시 ROBOT은 정지해야 합니다. <a href="#rule-g404" id="rule-g404"></a>
...
### 11.4.3 SCORING ELEMENT <a href="#s-11-4-3" id="s-11-4-3"></a>

{% hint style="success" %}
#### G405 \*SCORING ELEMENT를 FIELD 안에 유지하십시오. <a href="#rule-g405" id="rule-g405"></a>
...
{% hint style="success" %}
#### G406 \*ARENA를 손상시키거나 어지럽히지 마십시오. <a href="#rule-g406" id="rule-g406"></a>
...
{% hint style="success" %}
#### G407 동시에 4개를 초과하지 마십시오. <a href="#rule-g407" id="rule-g407"></a>
...
{% hint style="success" %}
#### G408 상대 NECTAR를 CONTROL하지 마십시오. <a href="#rule-g408" id="rule-g408"></a>
...
{% hint style="success" %}
#### G409 SCORING ELEMENT를 Catch하지 마십시오. <a href="#rule-g409" id="rule-g409"></a>
...
{% hint style="success" %}
#### G410 NECTAR는 마지막 1분에만 FLOWER에 넣을 수 있습니다. <a href="#rule-g410" id="rule-g410"></a>
...
{% hint style="success" %}
#### G411 \*SCORING ELEMENT를 독점하지 마십시오. <a href="#rule-g411" id="rule-g411"></a>
...
### 11.4.4 ROBOT <a href="#s-11-4-4" id="s-11-4-4"></a>

{% hint style="success" %}
#### G412 \*ROBOT은 Control 아래 있어야 합니다. <a href="#rule-g412" id="rule-g412"></a>
...
{% hint style="success" %}
#### G413 \*지시받으면 ROBOT을 정지하십시오. <a href="#rule-g413" id="rule-g413"></a>
...
{% hint style="success" %}
#### G414 \*ROBOT은 식별 가능해야 합니다. <a href="#rule-g414" id="rule-g414"></a>
...
{% hint style="success" %}
#### G415 \*ARENA와의 상호작용에 주의하십시오. <a href="#rule-g415" id="rule-g415"></a>
...
{% hint style="success" %}
#### G416 ROBOT Construction Limit을 지키십시오. <a href="#rule-g416" id="rule-g416"></a>
...
{% hint style="success" %}
#### G417 HIVE Structure를 간섭하지 마십시오. <a href="#rule-g417" id="rule-g417"></a>
...
{% hint style="success" %}
#### G418 FLOWER를 간섭하지 마십시오. <a href="#rule-g418" id="rule-g418"></a>
...
### 11.4.5 Opponent Interaction <a href="#s-11-4-5" id="s-11-4-5"></a>

G419와 G420은 상호 배타적입니다. 하나의 ROBOT-to-ROBOT Interaction이 둘 이상을 위반하면 가장 강한 Penalty 하나만 적용합니다.

{% hint style="success" %}
#### G419 \*상대 ROBOT을 손상시키지 마십시오. <a href="#rule-g419" id="rule-g419"></a>
...
{% hint style="success" %}
#### G420 \*상대를 Tip하거나 Entangle하지 마십시오. <a href="#rule-g420" id="rule-g420"></a>
...
{% hint style="success" %}
#### G421 \*PIN은 3-Count 제한입니다. <a href="#rule-g421" id="rule-g421"></a>
...
### 11.4.6 Human <a href="#s-11-4-6" id="s-11-4-6"></a>

{% hint style="success" %}
#### G422 \*DRIVE TEAM은 ALLIANCE AREA에 머무르십시오. <a href="#rule-g422" id="rule-g422"></a>
...
{% hint style="success" %}
#### G423 \*DRIVE COACH와 다른 팀은 Controller를 만지지 마십시오. <a href="#rule-g423" id="rule-g423"></a>
...
{% hint style="success" %}
#### G424 \*DRIVE COACH는 SCORING ELEMENT를 만지지 마십시오. <a href="#rule-g424" id="rule-g424"></a>
...
{% hint style="success" %}
#### G425 \*DRIVE TEAM은 손이 닿는 범위를 주의하십시오. <a href="#rule-g425" id="rule-g425"></a>
...
{% hint style="success" %}
#### G426 Human은 NECTAR를 너무 일찍 FIELD에 넣을 수 없습니다. <a href="#rule-g426" id="rule-g426"></a>
...
{% hint style="success" %}
#### G427 Human은 LOADING ZONE을 통해서만 NECTAR를 넣으십시오. <a href="#rule-g427" id="rule-g427"></a>
...
{% hint style="success" %}
#### G428 Human은 SCORING ELEMENT를 FIELD에서 제거하지 마십시오. <a href="#rule-g428" id="rule-g428"></a>
...
![BIOBUZZ 벌집 장식 그래픽](.gitbook/assets/image-052.jpg)
