...
![FTC-Events Region 배정 표시](.gitbook/assets/image-008.png)
...
![Tournament Advancement Structure](.gitbook/assets/image-009.png)
...
## 4.1 Advancement 포인트 계산 <a href="#s-4-1" id="s-4-1"></a>
...
| 항목                              | 획득하는 Advancement Points                                                                                             |
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| Qualification Phase Performance | Section 4.1.1의 공식에 따라 가장 높은 순위의 팀부터 가장 낮은 순위의 팀까지 16점에서 2점 사이가 정규분포 형태로 부여됩니다. 최소 2점, 최대 16점입니다.                    |
| ALLIANCE Lead                   | 21 − ALLIANCE Lead 번호. 예: ALLIANCE #3 Lead는 18점.                                                                    |
| Draft Order Acceptance          | 21 − Draft Order Acceptance 번호. 예: 세 번째 Draft Position을 수락한 팀은 18점.                                                 |
| Playoff Advancement             | <p>1위(Winners) 40점<br>2위(Finalists) 20점<br>3위 10점<br>4위 5점<br>Section 13.8 Dual Division Events의 변경 사항도 참고하십시오.</p> |
| Team Judged Awards              | <p>Inspire Award 1위 60점<br>2위 30점<br>3위 15점<br>그 밖의 1위 Award 12점<br>2위 6점<br>3위 3점<br>포인트 대상 Award 목록은 A211 참조.</p> |
...
| 순서   | 정렬 기준                                                                      |
| ---- | -------------------------------------------------------------------------- |
| 1st  | 총 Advancement Points(Table 4-1에 따라 계산)                                     |
| 2nd  | Judged Team Award Points                                                   |
| 3rd  | Playoff Advancement Points                                                 |
| 4th  | ALLIANCE Selection Results Points(ALLIANCE Lead 또는 Draft Order Acceptance) |
| 5th  | Qualification Phase Performance Points                                     |
| 6th  | Qualification MATCH 평균 점수(FOUL 제외)                                         |
| 7th  | Qualification AUTO 평균 점수                                                   |
| 8th  | 개별 Qualification MATCH 최고 점수(FOUL 제외)                                      |
| 9th  | 개별 Qualification MATCH 두 번째 최고 점수(FOUL 제외)                                 |
| 10th | Event Management System에 의한 무작위 선정                                         |

### 4.1.1 Qualification Phase Performance <a href="#s-4-1-1" id="s-4-1-1"></a>
...
![Qualification Phase Performance point formula](.gitbook/assets/image-010.png)
...
### 4.1.2 ALLIANCE Selection Results <a href="#s-4-1-2" id="s-4-1-2"></a>
...
### 4.1.3 Playoff Performance <a href="#s-4-1-3" id="s-4-1-3"></a>
...
### 4.1.4 Team Judged Awards <a href="#s-4-1-4" id="s-4-1-4"></a>
...
## 4.2 지역별 Advancement 배분 <a href="#s-4-2" id="s-4-2"></a>
...
![FTC-Events Event Advancement Information](.gitbook/assets/image-011.jpg)
