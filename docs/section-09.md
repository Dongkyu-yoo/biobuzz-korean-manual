...
![BIOBUZZ field elements](assets/image-023.png)

**Figure 9-1 · BIOBUZZ (Queue Area, FIELD Display, Optional Media Area는 그림에 없음)**

## 9.1 Dimensions and Accuracy {#s-9-1}
...
{% hint style="info" %}
ARENA는 Modular 구조이며 시즌 동안 여러 번 조립·사용·분해·운송되어 마모됩니다. 이벤트마다 일관성을 유지하기 위해 노력하지만 서로 다른 장소에서 서로 다른 Event Staff와 Volunteer가 조립하고 지역별 고유한 조건도 있어 작은 차이가 생길 수 있습니다.<br>
<br>
...
## 9.3 Areas, Zones, &amp; Markings {#s-9-3}
...
![BIOBUZZ zones and areas](assets/image-024.png)
...
![Loading zone and garden](assets/image-025.png)

**Figure 9-3 · LOADING ZONE and GARDEN (POLLEN 숨김)**

## 9.4 TILE Coordinates {#s-9-4}
...
![Tile seam locations](assets/image-026.png)

**Figure 9-4 · TILE Seam/Tab-line 위치**

![Tile locations](assets/image-027.png)

**Figure 9-5 · TILE 위치**

## 9.5 ALLIANCE AREA {#s-9-5}
...
![Alliance area](assets/image-028.png)

**Figure 9-6 · ALLIANCE AREA**

## 9.6 HIVE Structure {#s-9-6}

![HIVE Structure](assets/image-029.png)
...
![Frame dimensions](assets/image-030.png)
...
![HIVE details](assets/image-031.png)

**Figure 9-9 · HIVE Details**

![HIVE CELL key details](assets/image-032.png)

**Figure 9-10 · HIVE and CELL Key Details**

![CELL dimensions](assets/image-033.png)
...
![FLOWER details](assets/image-034.png)

**Figure 9-12 · FLOWER Details**

## 9.8 SCORING ELEMENTS {#s-9-8}
...
![POLLEN](assets/image-035.png)

**Figure 9-13 · POLLEN**

![NECTAR](assets/image-036.png)
...
![AprilTag Cluster layout](assets/image-037.png)
...
![AprilTag Cluster on CELL](assets/image-038.png)
...
![AprilTag locations](assets/image-039.png)

**Figure 9-17 · BIOBUZZ FIELD의 AprilTag 위치**

## 9.10 FIELD STAFF {#s-9-10}
...
## 9.11 Event Management System {#s-9-11}
...
<table><thead><tr><th>Event</th><th>Timer Value</th><th>Audio Cue</th></tr></thead><tbody>
<tr><td>MATCH Start</td><td>2:30</td><td>“This MATCH begins in 3, 2, 1, GO”(선택), “Cavalry Charge”</td></tr>
<tr><td>AUTO Ends</td><td>2:00</td><td>“Buzzer × 3”</td></tr>
<tr><td>AUTO → TELEOP Transition</td><td>0:08 → 0:01</td><td>“Drivers, pick up your controllers, 3-2-1”</td></tr>
<tr><td>TELEOP Begins</td><td>2:00</td><td>“3 Bells”</td></tr>
<tr><td>FLOWER Ownership Unlocked</td><td>1:00</td><td>[TBD]</td></tr>
<tr><td>Final 20 Seconds</td><td>0:20</td><td>“Train Whistle”</td></tr>
<tr><td>MATCH End</td><td>0:00</td><td>“3-second Buzzer”</td></tr>
<tr><td>MATCH Stopped</td><td>N/A</td><td>“Foghorn”</td></tr>
</tbody></table>

![BIOBUZZ divider](assets/image-040.jpg)
